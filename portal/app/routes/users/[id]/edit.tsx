      ...
      <body class="bg-gray-900 text-white min-h-screen">
        ...
        <main class="container mx-auto px-4 py-8 max-w-2xl">
          ...
          <div class="mb-8">
            ...
            <p class="text-gray-400">{user.name} の情報を編集します</p>
          </div>
          ...
          {/* 成功メッセージ表示エリア */}
          <div id="success-message" class="hidden mb-6 bg-green-900/50 border border-green-600 text-green-200 rounded-lg p-4">
            更新しました
          </div>
            ...
            <form id="user-form">
              ...
              <div class="mb-6">
                ...
                <select
                  ...
                  class="w-full bg-gray-700 text-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  <option value="user" selected={user.userType === 'user'}>
                    一般ユーザー
                  </option>
